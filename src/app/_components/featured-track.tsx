...
export default function FeaturedTrack({ song }: FeaturedTrackProps) {
  return (
    <div className="bg-neutral-100 dark:bg-slate-800 rounded-lg p-8 md:p-12">
      <h2 className="text-3xl md:text-4xl font-medium mb-6">Featured Track</h2>
      ...
      <div className="relative overflow-hidden py-8 mb-8">
        <div className="typewriter-container relative">
          <p className="text-2xl md:text-3xl font-medium  text-neutral-900 dark:text-neutral-100 typewriter-text">
            "{song.lyrics}"
          </p>
          <div className="typing-cursor"></div>
        </div>
        <p className="text-lg mt-4 text-neutral-600 dark:text-neutral-400">
          From the track <span className="font-medium">"{song.title}"</span>, {song.year}
        </p>
      </div>

      {/* Lyrics Annotation */}
      <div className="bg-[var(--card-background)] rounded-lg p-6 mb-6">
        <h3 className="text-xl font-medium mb-4">Behind the Lyrics</h3>
        {song.annotations.map((annotation, index) => (
          <div key={index} className="mb-4">
            <p className="font-medium mb-2">"{annotation.line}"</p>
