      ...
      <Container>
        <section className="max-w-3xl mx-auto mt-16 mb-12 bg-black/60 rounded-2xl shadow-xl p-8 border border-fuchsia-900/40 backdrop-blur-md">
          ...
          <p className="mb-4 text-lg text-white">
            <strong>Squealer and the Aggressors of Peace (Live)</strong> captures the raw energy, improvisation, and crowd connection of Klense's most ambitious project to date. Experience every lyric, every riff, and every moment as if you were front row at the show.
          </p>
...
// Place global styles outside the component to avoid nested styled-jsx error
// (Next.js will inject these globally)
import React from "react";
import Head from "next/head";

export function SataopLivePageStyles() {
  return (
    <Head>
      ...
      <style>{`
        ...
        .animated-heading .special-year {
          ...
          text-shadow: 0 2px 8px #7f1d1d44, 0 0 #fff;
        }
        .animated-heading .special-year {
          color: #b91c1c !important;
          text-shadow: 0 0 10px #b91c1ccc, 0 2px 8px #fff2;
        }
        .animated-heading .animated-letter.heading-top {
          color: #7f1d1d !important;
        }
        .animated-heading .animated-letter.heading-top2 {
          color: #be185d !important;
        }
        .animated-heading .animated-letter.heading-bottom {
          color: #7f1d1d !important;
        }
        .animated-heading .animated-letter.heading-bottom2 {
          color: #7f1d1d !important;
        }
        .animated-heading .animated-letter:hover {
          filter: drop-shadow(0 0 12px #b91c1ccc) brightness(1.2);
        }
        .animated-heading {
